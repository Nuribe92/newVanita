...
let stockProducts = [
    {
        ...
        precio: 15000,
        descripcion: "Tinta en textura cremosa y finalidad mate. Se difumina con facilidad. Larga duración.",
        cantidad: 1,
    ...
    },
    {
        ...
        precio: 12000,
        descripcion: "Sella la piel sin aportar color. Tambien es perfecto para retocar el maquillaje, pues quita el efecto graso de la piel y matifica sin aportar mas pigmento.",
        cantidad: 1,
    ...
    },
    {
        ...
        precio: 20000,
        descripcion: "Polvo micro pulverizado con pigmento de acuerdo al tono imagen tono 1 al 3 de izquierda a derecha",
        cantidad: 1,
    ...
    },
    {
        ...
        precio: 15000,
        descripcion: "Delineador con doble punta, una punta con sello para hacer el final del delineado y la otra punta con delineador punta plumón tradicional",
        cantidad: 1,
    ...
    },
    {
        ...
        precio: 18000,
        descripcion: "Kit de cejas con 2 tonos en betún y dos tonos en pigmento en polvo",
        cantidad: 1, 
    ...
    },
    {
        ...
        precio: 12000,
        descripcion:"Cobertura media/alta. Textura IDEAL para todo tipo de piel, no es muy matter, ni tampoco muy hidratante, es intermedio y bastante universal",
        cantidad:1,
    ...
    },
    {
        ...
        precio: 12000,
        descripcion:"Fórmula fluida y sedosa, se adhiere muy bien a la piel, alta pigmentacion y larga duración.",
        cantidad:1,
    ...
    },
    {
        ...
        precio: 20000,
        descripcion:"Pestañina con formula a prueba de agua, facil de retirar. 5 cepillos diferentes con acabados dependiendo de tu necesidad.",
        cantidad:1,
        img: 'xxx'
    },
    {
        ...
        precio: 12000,
        descripcion:"Textura en gel de rapido secado, resistente al agua y a transferencias, es retractil y se desliza facilmente.",
        cantidad:1,
    ...
    },
    {
        ...
        precio: 15000,
        descripcion:"Gel transparente que ayuda a peiinar y fijar tu cejas durante todo el dia. Puedes hacer técnicas organicas o tradicionales (Según cómo desees peinar los pelitos de tus cejas).",
        cantidad:1,
        img: 'xxx'
    },
    {
        ...
        precio: 10000,
        descripcion:"Tiene dos puntas, en un lado está el lápiz para cejas y en otro lado está el cepillo para peinarlas. Su punta es ultra precisa y de 1.5mm, lo cual simula los pelitos de forma Natural. Su fórmula es muy suave y desliza perfecto al contacto con la piel",
        cantidad:1,
    ...
    },
    {
        ...
        precio: 15000,
        descripcion:"¡Cejas Perfectas en minutos! Un producto perfecto para un acabado muy natural, NO fija con fuerza tus cejas, las ayuda a peinar con más facilidad. Su textura no es pesada, ni densa. Se deja manejar fácilmente.",
        cantidad:1,
    ...
    },
    {
        ...
        precio: 30000,
        descripcion:"Tonos tierra y cálidos, acabado mate y satinado, calidad profesional y excelente pigmentación.",
        cantidad:1,
    ...
    },
    {
        ...
        precio: 30000,
        descripcion:"Cuenta con 14 tonos mate y 7 tonos satinados, los tonos mate te ayudarán a crear transiciones y los satinados darán luz a tu mirada.",
        cantidad:1,
        img: 'img/imagenesProductos/SOMBRA-PERFECT-NEUTRAL-BEAUTY-GLAZED-REF-B27-4-removebg-preview.png'
    },
    {
        ...
        precio: 15000,
        descripcion:"Ideal para lograr una aplicacion uniforme de la base, úsala con productos en crema o liquidos. Fabricada con pelo sintético y mango de madera.",
        cantidad:1,
    ...
    },
    {
        ...
        precio: 12000,
        descripcion:"Por su forma angular es ideal para aplicar productos en polvo como rubor, contorno o bronceador. Fabricada con pelo sintético y mango de madera.",
        cantidad:1,
    ...
    },
    {
        ...
        precio: 15000,
        descripcion:"Ideal para lograr una aplicación de polvo uniforme en el rostro, úsala con productos en polvo como rubor, polvo compacto o traslúcido. Fabricada con pelo sintético y mango de madera.",
        cantidad:1,
    ...
    },
    {
        ...
        precio: 15000,
        descripcion:"¡Este Kit es un superbásico para tu maquillaje diario!, Incluye 1 difuminadora, 1 angular y 1 plana",
        cantidad:1,
    ...
    },
    {
        ...
        precio: 30000,
        descripcion:"¡Logra las pestañas de tus sueños con nuetros Serum para pestañas Trendy! COntiene Mezclas de ingredientes botánicos que estimulan el crecimiento de tus pestañas, refuerza la estructura capilar y previene la caida de tus pestañas y estimula la síntesis de queratina, aportando elasticidad, resistencia y brillo.",
        cantidad:1,
    ...
    },
    {
        ...
        precio: 15000,
        descripcion:"El mejor Accesorio para pestañas perfectas, una vez lo pruebas, se convierte en tu aliado, hecho en acero quirúrgico de excelente calidad y separar las pestañas evitando grumos, dando maximo alargamiento y volumen.",
        cantidad:1,
    ...
    },
    {
        ...
        precio: 15000,
        descripcion:"Convierte tus sombras en polvo favoritas en fórmulas fluidas, resistentes al agua y a prueba de manchas. Su textura líquida y liviana intensifica el pigmento para un resultado más impactante y duradero.",
        cantidad:1,
